...
<div class="container mx-auto my-10 p-8 bg-white shadow-lg rounded-lg">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('create') }}" class=" btn btn-primary text-white font-bold py-2 px-4 rounded">
            Tambah Pesanan
        </a>
    </div>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Nama Pesanan</th>
                        ...
                        <tr class="product-row border-b border-gray-200 hover:bg-gray-100 {{ $product['stock'] <= 3 ? 'low-stock' : '' }}">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <a href="{{ route('edit', $product['id']) }}" class=" btn btn-info text-white font-bold py-1 px-3 rounded mr-2">Edit</a>
